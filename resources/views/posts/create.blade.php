...
<div class="col-md-8 bg-white py-3">
    ...
    <div class="input-group mb-3">
        <input type="text" name="title" id="title" placeholder="حدد عنوان الموضوع" value="{{old('title')}}"
    ...
    <div class="input-group d-inline">
        <textarea name="body" id='editor'  class="form-control @error('body') is-invalid @enderror" id="">{{old("body")}}</textarea>
        @error('body')
        <span class="invalid-feedback">
            <strong>{{$message}}</strong>
        </span>
